$logFile = "E:\android-browser-for-unity\test-results\playmode.log"
$xmlFile = "E:\android-browser-for-unity\test-results\playmode.xml"
...
$proc = Start-Process -FilePath "C:\Program Files\Unity\Hub\Editor\6000.3.10f1\Editor\Unity.exe" `
    -ArgumentList "-batchmode -nographics -projectPath `"E:\android-browser-for-unity\src\unity`" -runTests -testPlatform PlayMode -testResults `"$xmlFile`" -logFile `"$logFile`"" `
    -PassThru
